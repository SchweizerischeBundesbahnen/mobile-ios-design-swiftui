...
class SBBCheckBoxTests: DSMTest {
    
    @Test func testCheckBoxTextOnly() {
    ...
    @Test func testCheckBoxWithImage() {
    ...
    @Test func testCheckBoxDisabled() {
