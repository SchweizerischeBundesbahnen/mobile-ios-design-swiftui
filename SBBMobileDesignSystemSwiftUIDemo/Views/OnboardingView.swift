...
struct OnboardingView: View {
    ...
    private let startView = SBBOnboardingTitleView(image: Image("Onboarding_Gang"), title: Text("Willkommen bei der Mobile Design System Library Demo App"))
    private let endView = SBBOnboardingTitleView(image: Image("Onboarding_Gang"), title: Text("Wir wünschen Ihnen viel Spass beim Erkunden aller Mobile Design System Elemente"))
    ...
    var body: some View {
        SBBOnboardingView(state: $viewModel.onboardingState, currentCardIndex: $viewModel.currentOnboardingCardIndex, startView: startView, endView: endView) {
            SBBOnboardingCardView(image: Image("Onboarding_Train"), title: Text("Mobile Design System"), text: Text("Dank dem Mobile Design System sind alle SBB Apps auf den ersten Blick als solche erkennbar und einfach benutzbar."))
