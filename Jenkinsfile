            ...
            steps {
                parallel(
                    'SBB DSM': {
                        node('ios') {
                            checkout scm
                            fastlane lane:'xcframework_ios_build', scheme:'SBBMobileDesignSystemSwiftUI', repo_artifact_id:'mobiledesignsystemswiftui-ios', stash_to:'mobiledesignsystemswiftui-ios', configuration:'Release-CargoStore'
                        }
                    },
