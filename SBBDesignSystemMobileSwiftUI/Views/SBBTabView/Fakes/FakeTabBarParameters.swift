...
struct FakeTabBarParameters {
    ...
    static let fakeClose = TabBarParameters(circleRadius: 22, circlePad: 6, topPad: 8, segmentWidth: 70, segmentWidths: [CGSize.zero], barHeight: 80, barWidth: 500, buttonHeight: 56, buttonWidth: 58, isPortrait: true)
}
